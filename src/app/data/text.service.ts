...
const rawTrans: RawTransArr = [
    ...
    { code: 0x60, eng: "<A>", shorthand: true },
    { code: 0x61, eng: "<B>", shorthand: true },
    { code: 0x62, eng: "<C>", shorthand: true },
    { code: 0x63, eng: "<D>", shorthand: true },
    { code: 0x64, eng: "<E>", shorthand: true },
    { code: 0x65, eng: "<F>", shorthand: true },
    { code: 0x66, eng: "<G>", shorthand: true },
    { code: 0x67, eng: "<H>", shorthand: true },
    { code: 0x68, eng: "<I>", shorthand: true },
    { code: 0x69, eng: "<V>", shorthand: true },
    { code: 0x6A, eng: "<S>", shorthand: true },
    { code: 0x6B, eng: "<L>", shorthand: true },
    { code: 0x6C, eng: "<M>", shorthand: true },
    { code: 0x6D, eng: "<:>", shorthand: true },
    { code: 0x70, eng: "<o'>", shorthand: true },
    { code: 0x71, eng: "<c'>", shorthand: true },
    { code: 0x72, eng: `<o">`, shorthand: true },
    { code: 0x73, eng: `<c">`, shorthand: true },
    { code: 0x74, eng: "<mdot>", shorthand: true },
    { code: 0x75, eng: "<...>", shorthand: true },
    { code: 0x79, eng: "<ul>", shorthand: true },
    { code: 0x7A, eng: "<horz>", shorthand: true },
    { code: 0x7B, eng: "<ur>", shorthand: true },
    { code: 0x7C, eng: "<vert>", shorthand: true },
